...
import { Accordion, AccordionDetails, AccordionSummary, Alert, CssBaseline, Snackbar } from '@mui/material';
      ...
      <SignerWalletContext>
        ...
        <div style={{
          ...
          <Accordion style={{ width: '60vw', alignSelf: 'center', marginBottom: '20px' }}>
            ...
            <AccordionDetails>
              This website uses the <a href="https://github.com/anza-xyz/wallet-adapter">Solana Wallet Adapter</a> to sign and verify simple messages offline. No information is stored or transmitted.
              <br></br>
              Github: <a href="https://github.com/sagar-a16z/simple-message-signer">https://github.com/sagar-a16z/simple-message-signer</a>
            </AccordionDetails>
          </Accordion>
        </div>
        <Snackbar
